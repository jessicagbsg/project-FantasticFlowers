...
eval("module.exports = __webpack_require__(/*! regenerator-runtime */ \"./node_modules/regenerator-runtime/runtime.js\");\n\n\n//# sourceURL=webpack://animaisfantasticos-main/./node_modules/@babel/runtime/regenerator/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initDropdownMenu)\n/* harmony export */ });\n/* harmony import */ var _outsideClick_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outsideClick.js */ \"./js/modules/outsideClick.js\");\n\nfunction initDropdownMenu() {\n  var activeClass = \"active\";\n  var dropdownMenu = document.querySelectorAll(\"[data-dropdown]\");\n\n  function handleClick(event) {\n    var _this = this;\n\n    event.preventDefault();\n    this.classList.add(activeClass);\n    (0,_outsideClick_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this, [\"touch\", \"click\"], function () {\n      _this.classList.remove(activeClass);\n    });\n  }\n\n  dropdownMenu.forEach(function (menu) {\n    [\"touch\", \"click\"].forEach(function (userEvent) {\n      menu.addEventListener(userEvent, handleClick);\n    });\n  });\n}\n\n//# sourceURL=webpack://animaisfantasticos-main/./js/modules/dropdown.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initFetchNumbers)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _numbers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./numbers.js */ \"./js/modules/numbers.js\");\n\n\n\nfunction initFetchNumbers() {\n  function createFlower(flower) {\n    var div = document.createElement(\"div\");\n    div.classList.add(\"flowers-numbers\");\n    div.innerHTML = \"<h3>\".concat(flower.specie, \"</h3><span data-numbers>\").concat(flower.total, \"</span>\");\n    return div;\n  }\n\n  function fetchFlowers(_x) {\n    return _fetchFlowers.apply(this, arguments);\n  }\n\n  function _fetchFlowers() {\n    _fetchFlowers = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(url) {\n      var flowersResponse, flowersJSON, gridNumbers;\n      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _context.prev = 0;\n              _context.next = 3;\n              return fetch(url);\n\n            case 3:\n              flowersResponse = _context.sent;\n              _context.next = 6;\n              return flowersResponse.json();\n\n            case 6:\n              flowersJSON = _context.sent;\n              gridNumbers = document.querySelector(\".numbers-grid\");\n              flowersJSON.forEach(function (flower) {\n                var divFlower = createFlower(flower);\n                gridNumbers.appendChild(divFlower);\n              });\n              (0,_numbers_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n              _context.next = 15;\n              break;\n\n            case 12:\n              _context.prev = 12;\n              _context.t0 = _context[\"catch\"](0);\n              console.log(_context.t0);\n\n            case 15:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee, null, [[0, 12]]);\n    }));\n    return _fetchFlowers.apply(this, arguments);\n  }\n\n  fetchFlowers(\"./flowersAPI.json\");\n}\n\n//# sourceURL=webpack://animaisfantasticos-main/./js/modules/fetchNumbers.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initOperation)\n/* harmony export */ });\nfunction initOperation() {\n  var operation = document.querySelector(\"[data-week]\");\n  var weekDay = operation.dataset.week.split(\",\").map(Number);\n  var weekShift = operation.dataset.shift.split(\",\").map(Number);\n  var dateNow = new Date();\n  var dayNow = dateNow.getDay();\n  var timeNow = dateNow.getHours();\n  var weekOpen = weekDay.indexOf(dayNow) !== -1;\n  var openShift = timeNow >= weekShift[0] && timeNow < weekShift[1];\n\n  if (weekOpen && openShift) {\n    operation.classList.add(\"open\");\n  }\n}\n\n//# sourceURL=webpack://animaisfantasticos-main/./js/modules/operation.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ _asyncToGenerator)\n/* harmony export */ });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {\n  try {\n    var info = gen[key](arg);\n    var value = info.value;\n  } catch (error) {\n    reject(error);\n    return;\n  }\n\n  if (info.done) {\n    resolve(value);\n  } else {\n    Promise.resolve(value).then(_next, _throw);\n  }\n}\n\nfunction _asyncToGenerator(fn) {\n  return function () {\n    var self = this,\n        args = arguments;\n    return new Promise(function (resolve, reject) {\n      var gen = fn.apply(self, args);\n\n      function _next(value) {\n        asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);\n      }\n\n      function _throw(err) {\n        asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);\n      }\n\n      _next(undefined);\n    });\n  };\n}\n\n//# sourceURL=webpack://animaisfantasticos-main/./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ _classCallCheck)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) {\n  if (!(instance instanceof Constructor)) {\n    throw new TypeError(\"Cannot call a class as a function\");\n  }\n}\n\n//# sourceURL=webpack://animaisfantasticos-main/./node_modules/@babel/runtime/helpers/esm/classCallCheck.js?");
